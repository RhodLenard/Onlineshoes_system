...
<html>
<head>
    <title>Sneakers Street - Running Shoes</title>
    ...
    <div id="container">
        ...
        <div class="nav1">
            <ul>
                ...
                <li>|</li>
                <li><a href="running1.php" class="active" style="color:#111;">Running</a></li> <!-- Active link for Running -->
            </ul>
        ...
        <div id="content" style="margin-bottom: 46.7%;">
            <br />
            <br />
            <div id="product">
                <form method="post">
